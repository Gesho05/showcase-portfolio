...
export default function Showcase() {
  return (
    <section id="section-showcase" className="relative text-black h-screen min-h-[100dvh] snap-start snap-always overflow-hidden px-[clamp(1rem,4vw,2.5rem)]">
      ...
      {/* Projects Grid */}
      <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 grid grid-cols-1 md:grid-cols-3 gap-6 justify-items-center z-10 px-[clamp(1rem,3vw,2rem)]">
          <ProjectCard
      ...
      {/* Footer Title */}
      <div className="absolute inset-x-0 bottom-5 z-10 justify-center items-center flex">
