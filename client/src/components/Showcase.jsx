...
export default function Showcase() {
  return (
    <section id="section-showcase" className="relative text-black h-screen min-h-[100dvh] snap-start snap-always overflow-hidden px-[clamp(1rem,4vw,2.5rem)]">
      ...
      {/* Description */}
      <div className="absolute top-8 left-1/2 -translate-x-1/2 z-10 w-[min(92vw,760px)] text-center text-sm leading-relaxed uppercase tracking-wider">
      ...
      {/* Static 3-card layout (straight, square-ish, overlay info) */}
      <div className="absolute inset-x-0 top-[51%] -translate-y-1/2 z-20 px-[clamp(1rem,3vw,2.5rem)]">
