...
import CrossyImg from "../assets/images/portfolio-cover.png";
import CrossyComputer from "../assets/images/portfolio-computer.png";
...
export default function Projects3() {
  ...
  const projectData = {
    ...
    description:
      'A PERSONAL PORTFOLIO WEBSITE TO SHOWCASE MY PROJECTS AND SKILLS FOR UNIVERCITY',
    image: CrossyImg,
